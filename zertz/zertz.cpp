...
Field_Iterator::Direction Field_Iterator::get_direction( Field_Pos from, Field_Pos to )
{
    if( from.y & 1 )		// if from row is odd
    {
        ...
        case  1:
            ...
            default:
                return Field_Iterator::invalid_direction;
            }
            break;
        case  0:
            switch( from.x - to.x )
...
Field_Iterator Field_Iterator::Next( Direction dir ) const
{
    ...
    case right:
        ...
        break;
    case top_right:
        return Next_Top_Right();
        break;
    case top_left:
        return Next_Top_Left();
        break;
    case left:
        return Next_Left();
        break;
    case bottom_left:
        return Next_Bottom_Left();
        break;
    case bottom_right:
        return Next_Bottom_Right();
        break;
    case right2:
        return Next_Right();
        break;
...
Move_Sequence Standard_Move_Translator::decode( std::istream &is )
{
    ...
    if( (first == 'x') || (first == 'X') ) // is knock out move ?
    {
        ...
        do
        {
            ...
            case 'w':
            case 'W':
                stone = Stones::white_stone;
                break;
            case 'g':
            case 'G':
                stone = Stones::grey_stone;
                break;
            case 'b':
            case 'B':
                stone = Stones::black_stone;
                break;
            default:
