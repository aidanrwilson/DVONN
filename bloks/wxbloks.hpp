...
public:
    ...
    inline bool get_is_flipped() const
    {
        return is_flipped;
    }
private:
...
public:
    ...
    inline bool get_is_flipped() const
    {
        return stone_panel.get_is_flipped();
    }
private:
    Settings &settings;
...
public:
    ...
    void add_stone_mark( std::pair<int/*x*/,int/*y*/> p )
    {
        static_stone_mark_positions.push_back(p);
    }
    void add_stone_mark( int x, int y )
    {
        static_stone_mark_positions.push_back(std::make_pair(x,y));
    }
    void clear_stone_marks()
    {
        static_stone_mark_positions.clear();
    }
    void add_field_mark( std::pair<int/*x*/,int/*y*/> p )
    {
        static_field_mark_positions.push_back(p);
    }
    void add_field_mark( int x, int y )
    {
        static_field_mark_positions.push_back(std::make_pair(x,y));
    }
    void clear_field_marks()
    {
        static_field_mark_positions.clear();
    }
