...
public:
    enum Direction { invalid_direction=-1,
                     ...
                     right_flipped=4, top_flipped=5, left_flipped=6, bottom_flipped=7
                   }; // in case a stone is placed in this direction, it is flipped upside down
    ...
    inline Field_Pos get_pos() const
    {
        return current_pos;
    }
...
public:
    ...
    const std::list<std::pair<unsigned/*x*/,unsigned/*y*/> > &get_sub_fields() const
    {
        return sub_fields;
    }
    const std::list<std::pair<int/*x*/,int/*y*/> > &get_corners() const
    {
        return corners;
    }
    ...
    unsigned get_max_x() const
    {
        return max_x;
    }
    unsigned get_max_y() const
    {
        return max_y;
    }
    ...
    bool get_rotation_symmetric() const
    {
        return rotation_symmetric;
    }
    bool get_flip_symmetric() const
    {
        return flip_symmetric;
    }
private:
...
inline bool operator==(Stone_Type s1, Stone_Type s2)
{
...
public:
    Stones();
    int get_total_stone_count() const
    {
        return total_count;
    }
    ...
    void set_stone_count(int stone_ID, int count)
    {
        ...
        stone_counts[stone_ID] = count;
        total_count += count;
    }
    void dec_stone_count(int stone_ID)
    {
        assert(does_include(stone_counts,stone_ID));
        --stone_counts[stone_ID];
        --total_count;
    }
    ...
    const std::map<int/*stone_ID*/, int/*count*/>& get_stone_counts() const
    {
        return stone_counts;
    }
...
public:
    ...
    Common_Stones_Type get_type() const
    {
        return type;
    }
protected:
...
public:
    ...
    inline Board_Type get_type() const
    {
        return board_type;
    }
    ...
    inline Field_State_Type get_field( Field_Pos pos )
    {
...
public:
    ...
    Rule_Violation get_check_fail_reason() const
    {
        return check_fail_reason;
    }
    //private:
    Field_Pos pos;
    int stone_type_ID;
...
public:
    ...
    inline const std::list<Move*> &get_moves() const
    {
        return *moves;
    }
    ...
    // for debug purposes
    const Ref_Counter* get_ref_counter() const
    {
        return ref_counter;
    }
private:
...
bool operator<( const Set_Move &m1, const Set_Move &m2 );
inline bool operator==( const Finish_Move &, const Finish_Move & )
{
    return true;
}
inline bool operator<( const Finish_Move &, const Finish_Move & )
...
public:
    ...
    {
        return current_variant == root;
    }
    bool remove_subtree( Variant * );

    inline Variant *get_current_variant()
    {
        return current_variant;
    }
    inline Variant *get_root_variant()
    {
        return root;
    }
    inline const Variant *get_current_variant() const
    {
        return current_variant;
    }
    inline const Variant *get_root_variant()    const
    {
        return root;
    }
...
public:
    ...
    void clear();
    void set_unique_id(unsigned id)
    {
        unique_id = id;
    }
...
public:
    ...
    Win_Condition_Type get_type() const
    {
        return type;
    }
protected:
...
public:
    ...
    inline Ruleset_Type get_type() const
    {
        return type;
    }
    inline unsigned get_min_players() const
    {
        return min_players;
    }
    inline unsigned get_max_players() const
    {
        return max_players;
    }
    inline Coordinate_Translator *get_coordinate_translator() const
    {
        return coordinate_translator;
    }
    inline void set_win_condition( Win_Condition *wc )
    {
...
public:
    ...
    {
        return winner_player_index;    // returns -1 if no player won
    }
    ...
    // *********************
    // information functions
    inline bool is_out_of_order()
    {
        return false;
    }
    inline unsigned get_min_players()
    {
        return ruleset->min_players;
    }
    inline unsigned get_max_players()
    {
        return ruleset->max_players;
    }
...
public:
    ...
    {
        return new Standard_Win_Condition();
    }
...
public:
    ...
    Rule_Violation get_rule_violation() const
    {
