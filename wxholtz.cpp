...
void Horizontal_Sizer::calc_dimensions()
{
    ...
    for( element = elements.begin(); element != elements.end(); ++element )
    {
        ...
        {
        case top:
            element->first->set_y(y);
            break;
        case bottom:
            element->first->set_y(y +  height - element->first->get_height());
            break;
        case middle:
            element->first->set_y(y + (height - element->first->get_height()) / 2);
            break;
        }
        element->first->calc_dimensions();
    }
...
void Vertical_Sizer::calc_dimensions()
{
    ...
    for( element = elements.begin(); element != elements.end(); ++element )
    {
        ...
        {
        case left:
            element->first->set_x(x);
            break;
        case right:
            element->first->set_x(x +  width - element->first->get_width());
            break;
        case center:
            element->first->set_x(x + (width - element->first->get_width()) / 2);
            break;
        }
        element->first->calc_dimensions();
    }
