...
bool read_board( std::escape_istream &eis, Board &board )
{
    ...
    switch(Board_State_Type(board_state))
    {
    case board_state_set_moves:
        dvonn_board_state = Board::set_moves;
        break;
    case board_state_jump_moves:
        dvonn_board_state = Board::jump_moves;
        break;
    default:
        return false;	// invalid board state
    }
...
void write_board( std::escape_ostream &eos, const Board &board )
{
    ...
    case Board::set_moves:
        board_state = board_state_set_moves;
        break;
    case Board::jump_moves:
        board_state = board_state_jump_moves;
        break;
    }
#elif defined(VERSION_BLOKS)
    board_state = board_state_default;
