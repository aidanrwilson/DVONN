...
public:
    ...
    void set_connection_handler(Network_Connection_Handler *handler)
    {
...
private:
    ...
    */
    ...
    public:
        ...
        {
            Start(milliseconds,wxTIMER_ONE_SHOT);
        }
        void stop()
        {
            Stop();
        ...
        virtual void Notify()
        {
            notifiee->on_connection_timer(connection);
        }
    private:
