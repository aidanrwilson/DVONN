...
public:
    ...
    {
        return "";    // message does not include message type
    }
...
public:
    ...
    std::list<Protocol> get_protocols()
    {
        return protocols;
    }
private:
...
{
public:
    Msg_Tell_Player_Setup( Setup s ) : Msg_Tell_Setup(s,true)
    {
        type = msg_tell_player_setup;
    }
    Msg_Tell_Player_Setup() : Msg_Tell_Setup(true)
    {
        type = msg_tell_player_setup;
    }
};
...
public:
    ...
    std::list<std::pair<Move_Sequence,int/*player index*/> > get_moves()
    {
        return moves;
    }
private:
...
public:
    Msg_Tell_Player_Moves( std::list<std::pair<Move_Sequence,int/*player index*/> > m )
        : Msg_Tell_Moves(m,true)
    {
        type = msg_tell_player_moves;
    }
    Msg_Tell_Player_Moves() : Msg_Tell_Moves(true)
    {
        type = msg_tell_player_moves;
    }
};
...
public:
    ...
    const std::list<Player> &get_players()
    {
        return players;
    }
private:
...
public:
    ...
    std::list<Setup_Change*>	get_changes()
    {
        return changes;
    }
    std::list<Setup_Change*>	obtain_changes()
    {
        return changes;
        changes.clear();
    }
...
public:
    ...
    std::string		get_old_host_nick()
    {
        return old_host_nick;
    }
    std::string		get_new_host_nick()
    {
        return new_host_nick;
    }
    std::list<int>		get_player_ids()
    {
        return player_ids;
    }
private:
