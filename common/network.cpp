...
{
    id=s.id;
    controlled_player_ids=s.controlled_player_ids;
    state=s.state;
    name=s.name;
    nick_name=s.nick_name;
    disconnecting=s.disconnecting;
    final_setup=s.final_setup;
    move_reminder=s.move_reminder;
    in_init=s.in_init;
    is_ready=s.is_ready;
    phase=s.phase;
    return *this;
...
bool Network_Manager_BGP100a_Server::do_player_up( int player_id )
{
    ...
    std::list<Player>::iterator player_iterator2 = player_iterator;
    --player_iterator2;
...
std::string Network_Manager_BGP100a_Client::to_string(Protocol_State state)
{
    ...
    case BGP_GET_PHASE:
        return "GET_PHASE";
    case BGP_SETUP_PREPARE_1:
        return "SETUP_PREPARE_1";
    case BGP_PLAY_PREPARE_1:
        return "PLAY_PREPARE_1";
    case BGP_PLAY_PREPARE_2:
        return "PLAY_PREPARE_2";
    case BGP_PLAY_PREPARE_3A:
        return "PLAY_PREPARE_3A";
    case BGP_PLAY_PREPARE_3B:
        return "PLAY_PREPARE_3B";
    case BGP_PLAY_PREPARE_4A:
        return "PLAY_PREPARE_4A";
    case BGP_TAKE_PLAYER:
        return "TAKE_PLAYER";
    case BGP_ASK_TAKE_PLAYER:
        return "ASK_TAKE_PLAYER";
    case BGP_SETUP:
        return "SETUP";
    case BGP_ADD_PLAYER:
        return "ADD_PLAYER";
