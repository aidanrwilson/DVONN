...
bool Board_Page::transfer_data_from_window(bool direction)
{
    ...
    if( changes )
    {
        if( new_game->GetValue() )
        {
            ...
            {
            case 0:
                game_dialog.game = Game( Basic_Ruleset() );
                break;
            case 1:
                game_dialog.game = Game( Standard_Ruleset() );
                break;
            case 2:
                game_dialog.game = Game( Tournament_Ruleset() );
                break;
            case 3: /*game will be set up in next page*/
                break;
            case 4:
                game_dialog.game = Game( *game_dialog.game_manager.get_game().ruleset );
            }
...
// 	  case 1: game_dialog.game = Game( Micro_Ruleset() ); break;
            case 1:
                game_dialog.game = Game( Random_Ruleset() );
                break;
            case 2:
                game_dialog.game = Game( *game_dialog.game_manager.get_game().ruleset );
            }
...
// 	  case 1: game_dialog.game = Game( Micro_Ruleset() ); break;
            case 1:
                game_dialog.game = Game( Small_Board_Ruleset() );
                break;
            case 2:
                game_dialog.game = Game( *game_dialog.game_manager.get_game().ruleset );
            }
            ...
            case 0:
                ...
                break;
            case 1:
                game_dialog.game = Game( Extended_Ruleset() );
                break;
            case 2:
                game_dialog.game = Game( *game_dialog.game_manager.get_game().ruleset );
            }
        ...
        else if( continue_game->GetValue() )
        {
            ...
            {
            case 0:
                game_dialog.game = game_dialog.game_manager.get_game();
                break;
            case 1: /*game will be set up in next page*/
                break;
            }
...
void Board_Page::restore()	// display stored game state
{
    ...
    if(can_choose)
    {
        ...
        {
        case Ruleset::basic:
            new_game_choice->SetSelection(0);
            break;
        case Ruleset::standard:
            new_game_choice->SetSelection(1);
            break;
        case Ruleset::tournament:
            new_game_choice->SetSelection(2);
            break;
        case Ruleset::custom:
            new_game_choice->SetSelection(3);
            break;
        }
    ...
    : wxPanel( parent, -1 ), game_dialog(game_dialog), changes(true)
{
    ...
    stones_white = new wxSpinCtrl(this, DIALOG_STONES_SPIN, wxT("5"));
    stones_white->SetRange(0,99);
    stones_custom_sizer->Add( stones_white, 0,  wxALL, 5 );
    stones_custom_sizer ->Add( new wxStaticText(this, -1, _("Grey marbles")),  0,  wxALL, 5 );
    stones_grey  = new wxSpinCtrl(this, DIALOG_STONES_SPIN, wxT("7"));
    stones_grey ->SetRange(0,99);
    stones_custom_sizer->Add( stones_grey,  0,  wxALL, 5 );
    stones_custom_sizer->Add( new wxStaticText(this, -1, _("Black marbles")), 0,  wxALL, 5 );
    stones_black = new wxSpinCtrl(this, DIALOG_STONES_SPIN, wxT("9"));
    stones_black->SetRange(0,99);
...
void Custom_Board_Setup_Panel::restore()
{
    ...
    case Board::s37_rings:
        board_choice->SetSelection(0);
        break;
    case Board::s40_rings:
        board_choice->SetSelection(1);
        break;
    case Board::s44_rings:
        board_choice->SetSelection(2);
        break;
    case Board::s48_rings:
        board_choice->SetSelection(3);
        break;
    case Board::s61_rings:
        board_choice->SetSelection(4);
        break;
    case Board::custom:    /* board_choice->SetSelection(5); // shouldn't happen */
        break;
    }
    switch( ruleset->win_condition->get_type() )
    {
    case Win_Condition::basic:
        win_choice->SetSelection(0);
        on_change_win(evt);
        break;
    case Win_Condition::standard:
        win_choice->SetSelection(1);
        on_change_win(evt);
        break;
    ...
    break;
    case Win_Condition::full_custom: /*win_choice->SetSelection(3); // shouldn't happen */
        break;
    }
    switch( ruleset->common_stones.get_type() )
    {
    case Common_Stones::basic:
        stones_choice->SetSelection(0);
        on_change_stones(evt);
        break;
    case Common_Stones::standard:
        stones_choice->SetSelection(1);
        on_change_stones(evt);
        break;
...
bool Load_PBM_Board_Page::scan_directory( wxString directory )
{
    ...
    for( i = pbm_files.begin(); i != pbm_files.end(); ++i )
    {
        ...
        if( master_content.from == 0 ) // display only boards that are specified from the first move on
        {
            ...
            {
            case PBM_Content::standard:
                board_str << _("Zertz");
                break;
            case PBM_Content::tournament:
                board_str << _("Zertz+11");
                break;
            }
#endif
...
void Player_Setup_Panel::on_add_player( wxCommandEvent& WXUNUSED(event) )
{
    ...
    if( game_dialog.game_setup_manager )
    {
        ...
        {
        case 0:
            help_mode = Player::no_help;
            break;
        case 1:
            help_mode = Player::show_possible_moves;
            break;
        case 2:
            help_mode = Player::show_hint;
            break;
        case -1:
            break;
        default:
...
wxString get_font_name( wxFont &font )
{
    ...
    else
    {
        ...
        {
        case wxDEFAULT:
            name = _("default family");
            break;
        case wxDECORATIVE:
            name = _("decorative family");
            break;
        case wxROMAN:
            name = _("roman family");
            break;
        case wxSCRIPT:
            name = _("script family");
            break;
        case wxSWISS:
            name = _("swiss family");
            break;
        case wxMODERN:
            name = _("modern family");
            break;
        case wxTELETYPE:
            name = _("teletype family");
            break;
        default:
            name = _("<unknown font>");
            break;
...
void Display_Setup_Page::restore_settings()
{
    ...
    {
    case Game_Panel::Settings::arrange_standard:
        arrangement_choice->SetSelection(0);
        break;
    case Game_Panel::Settings::arrange_stones_right:
        arrangement_choice->SetSelection(1);
        break;
    }
    ...
    case Game_Panel::Settings::arrange_standard:
        arrangement_choice->SetSelection(0);
        break;
    case Game_Panel::Settings::arrange_player_stones_right:
        arrangement_choice->SetSelection(1);
        break;
    }
    multiple_player_stones->SetValue( dialog->game_settings
...
void Display_Setup_Page::apply()
{
    ...
    {
    case 0:
        dialog->game_settings.arrangement = Game_Panel::Settings::arrange_standard;
        break;
    case 1:
        dialog->game_settings.arrangement = Game_Panel::Settings::arrange_stones_right;
        break;
    }
    ...
    case 0:
        ...
        break;
    case 1:
        dialog->game_settings.arrangement = Game_Panel::Settings::arrange_player_stones_right;
        break;
    }
    dialog->game_settings.player_settings.stone_settings.multiple_stones
        = multiple_player_stones->GetValue();
